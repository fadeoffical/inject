...
public @interface Handler {
     ...
     * {@link Handler this annotation} must either be the same or a subclass of the handler methods event type.
     * If the handler does not specify an event type, the here given event type is used as the event type
     * </p>
     *
